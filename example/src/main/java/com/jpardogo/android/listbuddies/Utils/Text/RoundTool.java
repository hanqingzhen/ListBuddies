...
public final class RoundTool {  
  ...
  public static void main(String[] argc) {
      ...
      System.out.println(round(-12.3401,1, BigDecimal.ROUND_UP));//-12.35
      //ROUND_DOWN  
      //与ROUND_UP相反  
      //直接舍弃第2位后面的所有小数  
      ...
      System.out.println(round(12.365,1, BigDecimal.ROUND_HALF_UP));//12.35
      System.out.println(round(12.3449,1, BigDecimal.ROUND_HALF_UP));//12.34
      System.out.println(round(-12.345,1, BigDecimal.ROUND_HALF_UP));//-12.35
      System.out.println(round(-12.3449,1, BigDecimal.ROUND_HALF_UP));//-12.34
      //ROUND_HALF_DOWN  
